...
import org.hei.federationagribackend.repository.AttendanceRepository; // Ajouté
...
public class CollectivityStatisticsService {
    ...
    public List<CollectivityLocalStatisticsDTO> getCollectivityLocalStatistics(
        ...
        for (MemberDTO member : members) {
            ...
            Double assiduity = attendanceRepository.calculateAssiduityPercentage(memberId, collectivityId, from, to);
            ...
            stats.setAssiduityPercentage(assiduity); // On remplit le nouveau champ
